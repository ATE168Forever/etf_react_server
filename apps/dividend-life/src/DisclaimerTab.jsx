...
export default function DisclaimerTab() {
  ...
  return (
    <div className="container content-page">
      <h2 className="h3 mt-4">{lang === 'en' ? 'Disclaimer' : '免責聲明'}</h2>
      ...
      <h3 className="h4">{lang === 'en' ? 'No Advisory' : '非投顧聲明'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Investment Risks' : '投資風險'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Data Sources & Accuracy' : '資料來源與正確性'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Price & Time Basis' : '價格與時間基準'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Taxes & Compliance' : '稅務與法遵'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Third-party Links & Disclosure' : '第三方連結與合作揭露'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Service Interruptions & Liability' : '服務中斷與責任限制'}</h3>
      <p>
        {lang === 'en'
      ...
      <h3 className="h4">{lang === 'en' ? 'Changes to Terms' : '條款變更'}</h3>
      <p>
        {lang === 'en'
