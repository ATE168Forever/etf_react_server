...
export default function InventoryTab() {
  ...
  const text = {
    zh: {
      ...
      notice: '這是一個免費網站。為確保你的使用者隱私，我們不會把任何資料存到後台或伺服器，所有紀錄（像是設定或操作紀錄）都只保存在你的瀏覽器裡；啟用自動儲存後也只會在本機備份。簡單說：資料只留在這台電腦，不會上傳，也不會被我們看到，請安心使用！',
      addRecord: '新增購買',
      dataAccess: '存取資料',
    ...
    en: {
      ...
      notice: 'This is a free website. To safeguard your privacy, we never store your data on any backend or server. Every record—like your settings or activity history—stays in your browser, and auto-save only keeps a local backup. In short: your data lives on this device, is never uploaded, and cannot be viewed by us.',
